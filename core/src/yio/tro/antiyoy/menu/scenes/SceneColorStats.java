...
public class SceneColorStats extends AbstractScene{
    ...
    public void create() {
        ...
        showPanel.appearFactor.beginSpawning(3, 1);
    ...
    public void hide() {
        ...
        menuControllerYio.getButtonById(56321).appearFactor.beginDestroying(1, 3);
        menuControllerYio.getButtonById(56322).destroy();
        menuControllerYio.getButtonById(56322).appearFactor.beginDestroying(1, 3);
    }
}